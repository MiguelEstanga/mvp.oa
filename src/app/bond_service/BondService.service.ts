...
export class BondService {
  ...
  async updateBondFromMessage(firebaseUid: string, messageText: string): Promise<CharacterUser> {
    ...
    // La curva es:
    // Nivel 1-2: +50 PV por cada 50 palabras
    // Nivel 2-3: +25 PV por cada 50 palabras
    // Nivel 3-7: +10 PV por cada 50 palabras
    // Nivel 8-10: +5 PV por cada 50 palabras
    ...
    const wordsPerSegment = 50; // Cambiado de 500 a 50
